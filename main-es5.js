...
var HighlightDirective = /** @class */ (function () {
    ...
    HighlightDirective.prototype.onClicks = function () {
        this.textDeco("yellow");
    };
    HighlightDirective.prototype.onDoubleClicks = function () {
        this.textDeco("None");
    };
    HighlightDirective.prototype.textDeco = function (action) {
...
var Quote = /** @class */ (function () {
    function Quote(id, author, name, description, completeDate) {
        this.id = id;
        this.author = author;
        this.name = name;
...
var QuoteComponent = /** @class */ (function () {
    ...
    QuoteComponent.prototype.deleteQuote = function (isComplete, index) {
        if (isComplete) {
            var toDelete = confirm("Are you sure you wanna delete' " + this.quotes[index.name]);
            if (toDelete) {
